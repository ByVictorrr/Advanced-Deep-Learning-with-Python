...
# Train the model
model = Word2Vec(sentences=gensim_downloader.load("text8"), # download and load the text8 dataset
                 sg=0,
                 vector_size=100,
                 window=5,
                 negative=5,
...
# Find the words most similar to 'woman' and 'king', but most dissimilar to 'man'
